 ...
 * 可以设置点击背景效果的线性布局
 */
public class TextViewBackground extends androidx.appcompat.widget.AppCompatTextView
{
	private Context mContext = null;
	private Drawable mBackground = null;
    private StateListDrawable statelistDrawable = null;
    
	public TextViewBackground(Context context)
	{
		super(context);
		mContext = context;
	}
	public TextViewBackground(Context context, AttributeSet attrs)
	{
		super(context, attrs);
		mContext = context;
	}
